...
Func Update_CheckNewPorgram(Const $bIsPortable, Const $hParent)
	...
	$hGUI.ComboAvaVersion = GUICtrlCreateCombo(Lng_Get("update.wait"), GUICtrlGetPos($hGUI.LabelAvaVersion)[2], 0, $aSize[0] - GUICtrlGetPos($hGUI.LabelAvaVersion)[2] - 50 - 6 * $iItemSpacing + 3, 17, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	$hGUI.PathRefresh = GUICtrlCreateButton("", GUICtrlGetPos($hGUI.ComboAvaVersion)[2] + 0, -2, 25, 25, $BS_ICON)
