...
If Not MapExists($MM_LNG_CACHE["mod_edit"]["group_caption"], "hint") Or Not IsString($MM_LNG_CACHE["mod_edit"]["group_caption"]["hint"]) Then $MM_LNG_CACHE["mod_edit"]["group_caption"]["hint"] = "If value is not set, an English part will be used. \n\nSo, there is no need to duplicate values from English to other languages."
