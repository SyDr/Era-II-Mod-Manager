...
Global Enum $MM_VIEW_MODS, $MM_VIEW_PLUGINS, $MM_VIEW_INSTALL, $MM_VIEW_BIG_SCREEN, $MM_VIEW_TOTAL
Global Enum $MM_SUBVIEW_DESC, $MM_SUBVIEW_INFO, $MM_SUBVIEW_SCREENS, $MM_SUBVIEW_TOTAL
...
Global Enum $LIST_MOD_ID, $LIST_IS_OPTIONAL
