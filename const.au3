...
Global Enum $MOD_ID, $MOD_IS_ENABLED, $MOD_IS_EXIST, $MOD_INFO_FILE, $MOD_INFO_PARSED, $MOD_ITEM_ID, $MOD_PARENT_ID, $MOD_DESCRIPTION_CACHE, $MOD_PLUGIN_CACHE, $MOD_TOTAL
